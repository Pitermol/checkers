...
class Cell_black extends React.Component {
    constructor() {
        this.state = {
    ...
    render() {
        <td className="cell_black_wrapper" style={border=this.state.is_highlighted_cell == 1 ? "6px ridge #43a60e;" : this.state.is_highlighted_cell == 2 ? "6px ridge #b39500" : this.state.is_highlighted_cell == 3 ? "6px ridge #991400" : "4px groove #a68a0e;"}>
